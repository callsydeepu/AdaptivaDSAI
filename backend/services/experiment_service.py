...
class ExperimentService:
    ...
    def create_experiment(
        ...
        return ExperimentRepository.save_experiment(experiment_data)

    @staticmethod
    def get_experiments(dataset_id: str) -> list:
        logger.info(f"Fetching all experiments for dataset: {dataset_id}")
        return ExperimentRepository.get_experiments_by_dataset(dataset_id)

    @staticmethod
    def get_experiment(experiment_id: str) -> dict:
        logger.info(f"Fetching experiment details for: {experiment_id}")
        return ExperimentRepository.get_experiment(experiment_id)
