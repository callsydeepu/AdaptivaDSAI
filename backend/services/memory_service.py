...
class MemoryService:
    ...
    def get_recent_context(session_id: str, limit: int = 10) -> list:
        ...
        history = CopilotRepository.get_session_history(session_id)
