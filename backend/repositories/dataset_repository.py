...
class DatasetRepository:
    ...
    @staticmethod
    def save_dataset(dataset_metadata):
    ...
    def delete_dataset(dataset_id):
        ...
        if db_connected and db is not None:
            try:
                res = db.datasets.delete_one({"_id": dataset_id})
        ...
        if os.path.exists(METADATA_FILE):
            try:
                ...
                datasets = [item for item in datasets if item["dataset_id"] != dataset_id]
